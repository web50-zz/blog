		...
		Ext.apply(this, {
			...
			items: [{
					...
					items: [
						...
						{fieldLabel: this.lblChngDate, name: 'changed_date', width: 100, format: 'Y-m-d H:i:s', allowBlank: true, xtype: 'datefield'},
						{fieldLabel: this.lblPublishDate, name: 'published_date', width: 100, format: 'Y-m-d H:i:s', allowBlank: true, xtype: 'datefield'},
