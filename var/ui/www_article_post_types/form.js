ui.www_article_post_types.form = Ext.extend(Ext.form.FormPanel, {
	formWidth: 450,
	formHeight: 300,
	...
	Load: function(data){
		var f = this.getForm();
		f.load({
			url: 'di/www_article_post_types/get.json',
	...
	Save: function(){
		...
		if (f.isValid()){
			f.submit({
				url: 'di/www_article_post_types/set.do',
	...
	constructor: function(config){
		...
		Ext.apply(this, {
			...
			items: [
				...
				{fieldLabel: this.lblRootPage, name: 'root_page_id', xtype: 'numberfield'},
		...
		ui.www_article_post_types.form.superclass.constructor.call(this, config);
		this.on({
