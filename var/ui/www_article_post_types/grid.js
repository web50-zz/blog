ui.www_article_post_types.grid = Ext.extend(Ext.grid.EditorGridPanel, {
	clmnTitle: "Название",
	clmnId:"Id",
	pagerSize: 50,
	...
	onRowMove: function(target, row){
		...
		Ext.Ajax.request({
			url: 'di/www_article_post_types/reorder.do',
			method: 'post',
	...
	constructor: function(config){
		Ext.apply(this, {
			store: new Ext.data.Store({
				proxy: new Ext.data.HttpProxy({
					api: {
						read: 'di/www_article_post_types/list.js',
						create: 'di/www_article_post_types/set.js',
						update: 'di/www_article_post_types/mset.js',
						destroy: 'di/www_article_post_types/unset.js'
					}
				}),
		...
		Ext.apply(this, {
			...
			enableDragDrop: true,
			ddGroup: 'www_article_post_types',
		...
		ui.www_article_post_types.grid.superclass.constructor.call(this, config);
		this.init(config);
	},
