ui.www_article_comment.main = Ext.extend(ui.www_article_comment.grid, {
	Load: function(data){
		this.setParams({}, true);
	},
	Add: function(){
	...
	constructor: function(config)
	{
		...
		Ext.apply(this, {
			...
			tbar: [
				...
				'->', {iconCls: 'help', handler: function(){showHelp('www_article_comment')}}
			]
		});
		Ext.apply(this, {
			listeners: {
				...
				rowmove: function(target, row){
					Ext.Ajax.request({
						url: 'di/www_article_comment/reorder.do',
						method: 'post',
