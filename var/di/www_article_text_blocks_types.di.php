...
/**
*
* @author	Fedot B Pozdnyakov 9@u9.ru 30.08.2018	
* @package	SBIN Diesel
*/
class di_www_article_text_blocks_types extends data_interface
{
	public $title = 'www: Статьи - типы текстовых блоков';
	...
	*/
	protected $name = 'www_article_text_blocks_types';
